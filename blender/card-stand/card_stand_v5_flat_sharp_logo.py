...
BACKPLATE_H = 138.0                 # printed flat on its back (zero supports - every raised
                                     ...
                                     # plate), not standing on edge - so the footprint is
                                     # BACKPLATE_W x BACKPLATE_H directly against the bed's two
                                     # shorter axes (143.4 x 89.6mm), and 160 didn't fit either way
BACKPLATE_T = 6.0
...
LOGO_ASPECT = 376.0 / 720.0          # logo_mask_v5.png's h:w - already cropped icon-only, so
                                     ...
                                     # region baked into this ratio anymore
LOGO_CENTER_X = 0.0
